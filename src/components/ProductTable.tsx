...
export default function ProductTable({ products, pageSlug = "table" }: ProductTableProps) {
  return (
    <div className="overflow-x-auto rounded-2xl border border-gray-100 shadow-sm my-8" role="region" aria-label="Jämförelsetabell">
      <table className="w-full text-sm">
        <thead className="bg-gray-50 text-gray-600 text-left">
          <tr>
            ...
            <th scope="col" className="px-4 py-3 font-semibold hidden md:table-cell">Svarstid</th>
            <th scope="col" className="px-4 py-3 font-semibold hidden lg:table-cell">Provtyp</th>

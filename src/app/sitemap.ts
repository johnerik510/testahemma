...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${BASE}/jamfor-hemmatester/`, lastModified: now, changeFrequency: "monthly", priority: 0.85 },
    { url: `${BASE}/diagnostikdirekt-vs-werlabs/`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    { url: `${BASE}/cerascreen-vs-medisera/`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    { url: `${BASE}/cerascreen-vs-verisana/`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    { url: `${BASE}/gettested-vs-cerascreen/`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    { url: `${BASE}/gettested-vs-medisera/`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    { url: `${BASE}/gettested-vs-testmottagningen/`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    { url: `${BASE}/gettested-vs-werlabs/`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    { url: `${BASE}/medisera-vs-verisana/`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    { url: `${BASE}/nordictest-vs-gettested/`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    { url: `${BASE}/werlabs-vs-cerascreen/`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    { url: `${BASE}/werlabs-vs-medisera/`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },

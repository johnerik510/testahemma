    ...
    <>
      ...
      <main className="max-w-3xl mx-auto px-4 py-10">
        ...
        <div className="prose-guide">
          <p>
            Högt kolesterol är tyst – det ger inga symtom men ökar risken för hjärtinfarkt och stroke dramatiskt. Hjärt-kärlsjukdom är fortfarande den vanligaste dödsorsaken i Sverige och högt LDL-kolesterol är en av de mest påverkbara riskfaktorerna. Det enda sättet att veta var du står är ett blodprov.
          </p>
          <p>
